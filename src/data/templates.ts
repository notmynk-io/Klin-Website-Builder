...
// Helper: Create Logo Placeholder Element
const createLogoPlaceholder = (label = '[ YOUR LOGO HERE ]'): ElementNode => ({
  id: generateId('logo-placeholder'),
  tagName: 'div',
  name: 'Logo Placeholder',
  classes: 'px-3 py-1.5 rounded-lg border-2 border-dashed border-[#E8A23D] bg-[#14161C] text-[#E8A23D] text-xs font-bold font-mono tracking-wider flex items-center gap-2 select-none hover:border-amber-400 transition cursor-pointer',
  children: [
    {
      id: generateId('logo-dot'),
      tagName: 'span',
      name: 'Logo Icon Dot',
      classes: 'w-2.5 h-2.5 rounded-full bg-[#E8A23D] animate-pulse shrink-0',
    },
    {
      id: generateId('logo-text'),
      tagName: 'span',
      name: 'Logo Text',
      classes: 'text-[#E8A23D] whitespace-nowrap',
      content: label,
    },
  ],
});
  ...
  children: [
    {
      ...
      children: [
        createLogoPlaceholder('[ YOUR LOGO HERE ]'),
        {
          id: generateId('nav'),
          tagName: 'nav',
          name: 'Nav Links',
  ...
  children: [
    {
      ...
      children: [
        createLogoPlaceholder('[ BRAND LOGO PLACEHOLDER ]'),
      ],
    },
    {
      id: generateId('p'),
